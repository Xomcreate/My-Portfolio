          ...
          {projectsData.map((project, index) => (
            ...
            >
              ...
              <div className="mt-4 flex space-x-4">
                <a href={project.liveDemo} target="_blank" rel="noreferrer" className="bg-[orangered] text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition-all duration-300">
                  View Live
                </a>
