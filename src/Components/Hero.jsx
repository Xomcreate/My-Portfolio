...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative h-screen w-full flex flex-col items-center justify-center font-serif text-[white] bg-cover bg-center"
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center space-y-8 p-4">
        ...
        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
          <a
            href="#projects"
            className=" bg-[orangered] hover:bg-blue-700 text-white py-2 px-4 rounded-full transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg"
          >
            View My Work
          </a>
          <a
