...
const Header = () => {
  ...
  return (
    <header className={`fixed w-full top-0 z-20 transition-all duration-300 ease-in-out ${isScrolled ? 'bg-[#000000a2] py-2 shadow-lg' : 'bg-transparent py-4'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-8">
          <Link
            ...
            smooth={true}
            duration={500}
            className="text-[orangered] text-[20px] font-bold hover:text-blue-300 cursor-pointer transition-colors duration-200"
          >
            Home
          </Link>
          <Link
            ...
            smooth={true}
            duration={500}
            className="text-white text-[20px] font-semibold hover:text-blue-300 cursor-pointer transition-colors duration-200"
          >
            About
          </Link>
          <Link
      ...
      {/* Mobile Menu */}
      <div
        className={`mobile-menu fixed top-0 right-0 w-3/4 h-full font-serif bg-[orangered] text-white z-20 transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}
      >
